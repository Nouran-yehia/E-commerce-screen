      ...
      <div class="overlap">
        <div class="fav">
          <div class="overlap-group">
            <img class="favorite" alt="Favorite" src="/img/favorite-1.svg" />
          </div>
        </div>
      </div>
      <div class="frame-3">
    ...
    <div class="frame-2">
      <div class="overlap-2">
        <div class="overlap-group-wrapper">
          <div class="overlap-group">
            <img class="favorite" alt="Favorite" src="/img/favorite-2.svg" />
          </div>
        </div>
...
.similar-products .overlap-group {
...
.similar-products .overlap-group-wrapper {
  height: 24px;
  left: 127px;
  overflow: hidden;
  position: absolute;
...
.similar-products .div-wrapper-2 {
  align-items: flex-start;
  background-color: #ffffff;
  display: inline-flex;
  gap: 10px;
